...
export const translations = {
  en: {
    ...
    errorProfileFetch: 'There was a problem loading your profile. This might be due to a network issue or an incomplete account setup. Please try logging in again.',
  ...
  id: {
    ...
    errorProfileFetch: 'Terjadi masalah saat memuat profil Anda. Ini mungkin karena masalah jaringan atau pengaturan akun yang belum lengkap. Silakan coba masuk lagi.',
